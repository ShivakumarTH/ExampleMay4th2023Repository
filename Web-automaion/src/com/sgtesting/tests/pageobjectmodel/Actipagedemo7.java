...
public class Actipagedemo7 {

	public  Actipagedemo7(WebDriver oBrowser)
	{
	...
	public static Actipagedemo7 opage=null;
	...
	private static void launch()
	{
		try {
			...
			opage=new Actipagedemo7(oBrowser);
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	private static void CreateProject()
	{
		try {
			...
			Thread.sleep(2000);
			opage.getname().sendKeys("a Project");
			Thread.sleep(2000);
	...
	private static void CreateTask()
    {
    	try {
    		...
    		opage.Addnew().click();
    		Thread.sleep(2000);
    		opage.entername().sendKeys("AB");
    		Thread.sleep(2000);
    		opage.getentername2().sendKeys("DBIT");
    		Thread.sleep(2000);
