...
public class Actipagedemo6 {

	public  Actipagedemo6(WebDriver oBrowser)
	{
	...
	public static Actipagedemo6 opage=null;
	...
	private static void launch()
	{
		try {
			...
			opage=new Actipagedemo6(oBrowser);
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	private static void CreateProject()
	{
		try {
			...
			Thread.sleep(2000);
			opage.getname().sendKeys("abcd");
			Thread.sleep(2000);
			opage.getdesc().sendKeys("ajjdd");
			Thread.sleep(2000);
			opage.getproject().click();
			Thread.sleep(2000);
		} catch (Exception e) {
